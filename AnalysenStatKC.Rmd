...
#### DxI-800
```{r prepare_DxI_data, echo=FALSE, message=FALSE, warning=FALSE}
...
#left join to get tax point information from tariff, remove junk data, save tidy data
dxi.anpijona <- left_join(dxi.analy.pivot, tarif.scales, by = c("Bezeichnung", "Methode"), keep = FALSE, multiple = "any")

tidy.dxi.data <- subset(dxi.anpijona, select = -c(Tagesnummer))
