...
sum.data <- combined.data |> 
  ...
  summarize(
    ...
    Auftraege_Hochd. = sum(AU_Auftraege, DxI_Auftraege, na.rm = TRUE), 
...
sum.data.22 |>  
  ...
  bg(bg = "grey", part = "header") |> 
  set_header_labels(
    TxpUmsatz_KC = "TxpUmsatz -Hochdurchsatz",
...
# list all files in the directory
files <- list.files("/Users/olli/R/labStat")
data_path <- "/Users/olli/R/labStat"
